...
import edu.upc.whatsapp.adapter.MyAdapter_messagesRecycleView;
...
public class e_MessagesActivity extends Activity {
    ...
    private MyAdapter_messagesRecycleView adapter;
    ...
    private class fetchAllMessages_Task extends AsyncTask<Integer, Void, List<Message>> {
        ...
        protected void onPostExecute(List<Message> all_messages) {
            ...
            if (all_messages == null) {
                ...
                adapter = new MyAdapter_messagesRecycleView(e_MessagesActivity.this, all_messages, globalState.my_user);
                conversation.setAdapter(adapter);
                conversation.setLayoutManager(new LinearLayoutManager(e_MessagesActivity.this));
            ...
            public void onGlobalLayout() {
                ...
                if (heightDifference > 50 && !enlarged) {
                    ...
                    conversation.post(new Runnable() {
                        @Override
                        public void run() {
                            conversation.scrollToPosition(conversation.getAdapter().getItemCount() - 1);
                        }
                    });
                }
