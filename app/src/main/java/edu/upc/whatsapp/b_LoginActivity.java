...
public class b_LoginActivity extends Activity implements View.OnClickListener {
  ...
  public void onClick(View arg0) {
    if (arg0 == findViewById(R.id.editloginButton)) {
      ...
      EditText loginTextView = (EditText) findViewById(R.id.editTextLogin_login);
      EditText passwordTextView = (EditText) findViewById(R.id.editTextPassword_login);
  ...
  private class OperationPerformer extends Thread {
    ...
    public void run() {
      ...
      UserInfo userInfoRPC = RPC.login(user);
  ...
  Handler handler = new Handler() {
    ...
    public void handleMessage(Message msg) {
      ...
      if (userInfo.getId() >= 0) {
        ...
        Intent myIntent = new Intent(b_LoginActivity.this, d_UsersListActivity.class);
